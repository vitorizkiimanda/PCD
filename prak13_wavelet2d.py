...
coeff = pywt.dwt2(gray, "db2")  # ---- Dekomposisi lv 1
LL, (LH, HL, HH) = coeff
coeff = pywt.dwt2(LL, "db2")
LL, (LH, HL, HH) = coeff
coeff = pywt.dwt2(LL, "db2")
LL, (LH, HL, HH) = coeff
coeff = pywt.dwt2(LL, "db2")
...
# # print (c)
plotCoeffsImage(c, name, '4')
plotCoeffsSpec(LL, 'll', '4')
plotCoeffsSpec(LH, 'lh', '4')
plotCoeffsSpec(HL, 'hl', '4')
plotCoeffsSpec(HH, 'hh', '4')
combineFigSpec('ll.jpg', 'lh.jpg', 'hl.jpg', 'hh.jpg', '4')
#
#
